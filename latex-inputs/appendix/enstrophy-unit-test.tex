...
terms.
\subsubsection{$\aenst$ term}
\begin{figure}[H]
    \includegraphics[height=0.35\textheight]{media/enstrophy-transport-terms/A-term-approx.pdf}
    \caption{Approximate solution for $\aenst$ term}
    \label{fig:a-approx}
\end{figure}

\begin{figure}[H]
    \includegraphics[height=0.35\textheight]{media/enstrophy-transport-terms/A-term-exact.pdf}
